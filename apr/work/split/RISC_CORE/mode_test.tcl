################################################################################
#
# Created by icc2 split_constraints on Wed May 17 12:54:50 2023
#
################################################################################
...
create_clock -add -name {SYS_2x_CLK} -period 2.40000  \
	-waveform {0.00000 1.20000} [get_ports {n1194}]
...
create_clock -add -name {ate_clk} -period 30.00000  \
	-waveform {0.00000 15.00000} [get_ports {n1194}]
...
# Boundary constants
set_case_analysis 1 [get_ports {n1788}]
set_case_analysis 1 [get_ports {n913}]
