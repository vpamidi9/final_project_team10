...
create_clock -add -name {ate_clk} -period 30.00000  \
	-waveform {0.00000 15.00000} [get_ports {clk}]
...
group_path -priority -1 -name {SYS_CLK} -to [get_clock  \
	{virtual_SYS_CLK.2_r}]
# Virtual clock virtual_ate_clk.5_r.5 based on original clock ate_clk 
create_clock -name {virtual_ate_clk.5_r.5} -period 30.00000  \
	-waveform {0.00000 15.00000} 
group_path -priority -1 -name {ate_clk} -to [get_clock  \
	{virtual_ate_clk.5_r.5}]
...
set_case_analysis 0 [get_ports {IN45}]
...
set_case_analysis 1 [get_ports {IN0}]
set_case_analysis 1 [get_ports {IN1}]
set_case_analysis 1 [get_ports {IN2}]
set_case_analysis 1 [get_ports {IN3}]
set_case_analysis 1 [get_ports {IN4}]
set_case_analysis 1 [get_ports {IN5}]
set_case_analysis 1 [get_ports {IN19}]
set_case_analysis 1 [get_ports {IN20}]
set_case_analysis 1 [get_ports {IN11}]
set_case_analysis 1 [get_ports {IN54}]
set_case_analysis 1 [get_ports {scan_enable}]
set_case_analysis 1 [get_ports {IN61}]
set_case_analysis 1 [get_ports {IN62}]
set_case_analysis 1 [get_ports {IN65}]
set_case_analysis 1 [get_ports {IN66}]
set_case_analysis 1 [get_ports {IN67}]
set_case_analysis 1 [get_ports {IN68}]
set_case_analysis 1 [get_ports {IN69}]
set_case_analysis 1 [get_ports {IN70}]
set_case_analysis 1 [get_ports {IN71}]
set_case_analysis 1 [get_ports {IN72}]
set_case_analysis 1 [get_ports {IN73}]
set_case_analysis 1 [get_ports {IN74}]
set_case_analysis 1 [get_ports {IN75}]
set_case_analysis 1 [get_ports {IN76}]
set_case_analysis 1 [get_ports {IN77}]
set_case_analysis 1 [get_ports {IN78}]
set_case_analysis 1 [get_ports {IN79}]
set_case_analysis 1 [get_ports {IN80}]
set_case_analysis 1 [get_ports {IN81}]
set_case_analysis 1 [get_ports {IN82}]
set_case_analysis 1 [get_ports {IN83}]
set_case_analysis 1 [get_ports {IN84}]
set_case_analysis 1 [get_ports {IN85}]
set_case_analysis 1 [get_ports {IN86}]
set_case_analysis 1 [get_ports {IN87}]
set_case_analysis 1 [get_ports {IN88}]
set_case_analysis 1 [get_ports {IN89}]
set_case_analysis 1 [get_ports {IN90}]
set_case_analysis 1 [get_ports {IN91}]
set_case_analysis 1 [get_ports {IN92}]
