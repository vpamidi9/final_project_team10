################################################################################
#
# Created by icc2 split_constraints on Wed May 17 12:54:47 2023
#
################################################################################
...
set_case_analysis 0 [get_ports {IN87}]
set_case_analysis 0 [get_ports {IN88}]
set_case_analysis 0 [get_ports {IN89}]
set_case_analysis 0 [get_ports {IN90}]
set_case_analysis 0 [get_ports {IN91}]
set_case_analysis 0 [get_ports {IN92}]
