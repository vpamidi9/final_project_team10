...
create_clock -add -name {ate_clk/pclk_cts_9} -period 30.00000  \
	-waveform {0.00000 15.00000} [get_ports {pclk_cts_9}]
group_path -priority -1 -name {ate_clk} -to [get_clock {ate_clk/pclk_cts_9}]
create_clock -add -name {ate_clk/sys_clk_BAR} -period 30.00000  \
	-waveform {0.00000 15.00000} [get_ports {sys_clk_BAR}]
...
set_case_analysis 1 [get_ports {pci_rst_n}]
set_case_analysis 1 [get_ports {sys_rst_n}]
set_case_analysis 1 [get_ports {pclk_cts_7}]
set_case_analysis 1 [get_ports {IN29}]
set_case_analysis 1 [get_ports {scan_enable}]
set_case_analysis 1 [get_ports {IN30}]
set_case_analysis 1 [get_ports {IN31}]
set_case_analysis 1 [get_ports {IN32}]
set_case_analysis 1 [get_ports {IN33}]
set_case_analysis 1 [get_ports {IN34}]
set_case_analysis 1 [get_ports {IN35}]
set_case_analysis 1 [get_ports {IN36}]
set_case_analysis 1 [get_ports {IN37}]
set_case_analysis 1 [get_ports {IN38}]
...
set_clock_groups -name my_occ_clock_groups -asynchronous -group [get_clocks \
    {ate_clk/pclk_cts_9 ate_clk/sys_clk_BAR}] -group [get_clocks {SYS_2x_CLK \
    SYS_CLK SDRAM_CLK v_SDRAM_CLK SD_DDR_CLK SD_DDR_CLKn PCI_CLK v_PCI_CLK}]
# MD5_SIGNATURE: 052422516581B74DBC37153F493495C1 
