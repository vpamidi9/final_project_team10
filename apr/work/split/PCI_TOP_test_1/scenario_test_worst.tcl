...
set_clock_uncertainty -setup 0.1 [get_clocks {ate_clk/pclk_cts_9 \
    ate_clk/sys_clk_BAR}]
set_clock_uncertainty -hold 0 [get_clocks {ate_clk/pclk_cts_9 \
    ate_clk/sys_clk_BAR}]
...
set_clock_transition 0.2 [get_clocks {ate_clk/pclk_cts_9 ate_clk/sys_clk_BAR}]

# MD5_SIGNATURE: 516D779CE6158D246109745473164BDD 
