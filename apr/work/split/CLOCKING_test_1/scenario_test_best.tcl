...
set_clock_transition 0.1 [get_clocks {SYS_2x_CLK/sys_2x_clk_in SYS_2x_CLK/in}]
set_clock_transition 0.1 [get_clocks {SYS_CLK}]
set_clock_transition 0.1 [get_clocks {SDRAM_CLK}]
set_clock_transition 0.1 [get_clocks {ate_clk/pclk_in ate_clk/sdram_clk_in \
    ate_clk/sys_2x_clk_in ate_clk/ate_clk}]

# MD5_SIGNATURE: 04F8FC1AB338426E5820C6472EEB527E 
