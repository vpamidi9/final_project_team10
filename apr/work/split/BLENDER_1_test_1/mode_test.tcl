...
set_case_analysis 1 [get_ports {IN14}]
set_case_analysis 1 [get_ports {IN6}]
set_case_analysis 1 [get_ports {IN19}]
set_case_analysis 1 [get_ports {IN55}]
set_case_analysis 1 [get_ports {scan_enable}]
set_case_analysis 1 [get_ports {IN58}]
set_case_analysis 1 [get_ports {IN59}]
set_case_analysis 1 [get_ports {IN63}]
set_case_analysis 1 [get_ports {IN64}]
