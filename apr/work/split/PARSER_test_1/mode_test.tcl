...
create_clock -add -name {ate_clk/sys_clk_cts_0_1} -period 30.00000  \
	-waveform {0.00000 15.00000} [get_ports {sys_clk_cts_0_1}]
group_path -priority -1 -name {ate_clk} -to [get_clock  \
	{ate_clk/sys_clk_cts_0_1}]
...
set_case_analysis 1 [get_ports {IN25}]
set_case_analysis 1 [get_ports {IN26}]
set_case_analysis 1 [get_ports {test_sea}]
set_case_analysis 1 [get_ports {IN28}]
...
set_clock_groups -name my_occ_clock_groups -asynchronous -group [get_clocks \
    {ate_clk/sys_clk ate_clk/sys_clk_cts_7 ate_clk/sys_clk_cts_9 \
    ate_clk/sys_clk_cts_0_1}] -group [get_clocks {SYS_2x_CLK SYS_CLK/sys_clk \
...
# MD5_SIGNATURE: 369A02B99206CC581622CF1CA5446E6C 
