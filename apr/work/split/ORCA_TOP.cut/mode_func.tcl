...
set_block_to_top_map -path {I_CLOCKING} -clock {func SYS_2x_CLK/sys_2x_clk_in SYS_2x_CLK}
set_block_to_top_map -path {I_CLOCKING} -clock {func SYS_2x_CLK/in SYS_2x_CLK}
