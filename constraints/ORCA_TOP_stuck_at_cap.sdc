...
create_clock [get_ports sys_2x_clk]  -name SYS_2x_CLK  -period 3.0  -waveform {0 1.5}
...
# Scan clock
create_clock [get_ports ate_clk]  -period 5.00  -waveform {0 2.50}
...
create_clock -name v_SDRAM_CLK  -period 4.0  -waveform {0 2.00}
...
set_input_delay 3.0 -clock ate_clk [get_ports scan_enable]
set_input_delay 3.0 -clock ate_clk [get_ports {test_si[5]}]
set_input_delay 3.0 -clock ate_clk [get_ports {test_si[4]}]
set_input_delay 3.0 -clock ate_clk [get_ports {test_si[3]}]
set_input_delay 3.0 -clock ate_clk [get_ports {test_si[2]}]
set_input_delay 3.0 -clock ate_clk [get_ports {test_si[1]}]
set_input_delay 3.0 -clock ate_clk [get_ports {test_si[0]}]
set_input_delay 3.0 -clock ate_clk [get_ports test_mode]
set_input_delay 3.0 -clock ate_clk [get_ports occ_bypass]
set_input_delay 3.0 -clock ate_clk [get_ports occ_reset]
