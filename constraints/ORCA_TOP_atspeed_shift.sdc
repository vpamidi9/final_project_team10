...
create_clock [get_ports sys_2x_clk]  -name SYS_2x_CLK  -period 4.2  -waveform {0 2.1}
...
create_clock [get_ports sdram_clk]  -name SDRAM_CLK  -period 4.5  -waveform {0 2.50}
...
# Scan clock
create_clock [get_ports ate_clk]  -period 12.00  -waveform {0 6.0}
